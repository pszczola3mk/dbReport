...
public class RedirectPage extends UI {
	...
	private void addForm() {
		...
		button.addClickListener(clickEvent -> Try.ofCallable(new User(tfUrl, tfUserName, tfPassword, this.business)).andThen(this::showSuccess).getOrElse(this::showError));
